...
*NOMOR CREATOR*
▼▼▼▼▼`)
sendKontak(from, `6287772961550`, `${ownerName}`, 'Sibukk!!')
               await sleep(1000)
               break
               case 'spamcall':{
...
anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/ppcouple?apikey=IkyOgiwara`)
            ...
            buff2 = await getBuffer(anu.result.female)
              ...
              buttonsMessage = {footerText:'assalamualaikum 𝑩𝒐𝒕𝒛🌠', imageMessage: imageMsg,
...
//------------------< Premium >-------------------
       ...
       case 'sewabot':
              gopeynya = 'https://i.top4top.io/p_2134ztfrd0.jpg'
...
┃💌 : wa.me/6287772961550
┃💌 : ==============
┃💌 : Instagram : _*@revi_ganz*_
┃💌 : YouTube : _*YT EDIT 3D*_
┗━━⬣
`
...
᎒ SUBS YT EDIT 3D DULU BARU TAK KASIH
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport': 
              ...
              ikyy.sendMessage('6287772961550@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'jawaban':
       ...
       case 'request':
              ...
              ikyy.sendMessage('6287772961550@s.whatsapp.net',`*Request:* ${teks}`, text)
              break
case 'chatrava':
              if (args.length < 1) return reply(`Ketik ${prefix}CHAT [CHAT apa]`) 
              teks = args.join(' ')
              reply('CHAT RAVA DONE')
              ikyy.sendMessage('6287772961550@s.whatsapp.net',`*chat:* ${teks}`, text)
              break
       case 'readall':
